  ...
  - name: "GenerateAssessmentReport"
    ...
    outputs:
      - name: "cmmi_gai_report"
        desc: "Comprehensive CMMI maturity report for Generative AI as if written by a Capability Maturity Model Integration (CMMI) For Business Processes and Generative AI expert. Do not reveal specific questions or answers. Write in the second person perspective"
  ...
  return (
    <main className="flex min-h-screen flex-col p-6 flex-initial bg-white">
      <div className="bg-white p-8 rounded-lg shadow-md w-full mx-auto">
        <h2>
          Applied Direct Services Corporation (ADSC) Instrument To Assess The
        ...
        />
        <button
          className="bg-primary px-4 py-2 text-base font-normal text-primary-foreground hover:bg-primary/90 w-max"
          onClick={handleClick}
        >
          Generate Assessment
        </button>
